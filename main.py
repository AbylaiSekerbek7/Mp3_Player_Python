...
IMAGE_PATH = 'images/main pic.png'
...
class Player(ttk.Frame):
    ...
    def __init__(self, master):
        ...
        self.play_list = Listbox(master, font="Sansarif 12 bold", bd=5, bg="#1e1e1e", fg="#ffffff", width=37, height=19, selectbackground="#1db954")
        ...
        self.var = StringVar()
        self.var.set("..............................................................................")
        self.song_title = Label(master, font="Helvetica 12 bold", bg="#1e1e1e", fg="#ffffff", width=55, textvariable=self.var)
    ...
    def exit(self):
        MsgBox = askquestion('Exit Application', 'Are you sure you want to exit the music player.', icon='warning')
        if MsgBox == 'yes':
            self.master.quit()
    ...
    def help(self):
        ...
        user_manual = [
            ...
            "7. unmute symbol = 🔇",
            "8. stop button = ■ ",
            "\n\n| Made by Sekerbek Abylaikhan ITSTEP | Copyright @ 2024 |\n"
        ]
    ...
    def main_window(self):
        ...
        self.button_play = Button(self.master, text=self.PLAY, width=5, bd=5, bg="#1db954", fg="white", font="Helvetica, 15", command=self.play_thread)
        ...
        self.label_time = Label(self.master, text="00:00:00 / 00:00:00", bg="#1e1e1e", fg="#ffffff")
